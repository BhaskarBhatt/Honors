...
# concatenated audio sequence: aa_ae_ah_aw_ey

# Read audio file and find its sample rate
samplerate, data = wavfile.read('/home/bhaskar/Desktop/Honors/Task 5 (Concatenated Isolated Vowels)/isolated_wav/aa_ae_ah_aw_ey.wav')
...
# Load the features
features = np.load('/home/bhaskar/Desktop/Honors/Task 5 (Concatenated Isolated Vowels)/extracted_features/aa_ae_ah_aw_ey.npy') 
