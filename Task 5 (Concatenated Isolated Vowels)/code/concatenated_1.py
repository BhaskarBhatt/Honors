...
# concatenated feature sequence: aa_ae_ah_aw_ey
...
audio_files = ['aa.wav', 'ae.wav', 'ah.wav', 'aw.wav', 'ey.wav']  # Replace with actual file names if different
feature_files = ['aa.npy', 'ae.npy', 'ah.npy', 'aw.npy', 'ey.npy']
