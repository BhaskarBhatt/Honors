...
samplerate, data = wavfile.read('/home/bhaskar/Desktop/Honors/Task 5 (Concatenated Isolated Vowels)/isolated_wav/uh.wav')
...
# Load the features
features = np.load('/home/bhaskar/Desktop/Honors/Task 5 (Concatenated Isolated Vowels)/extracted_features/uh.npy') 
