...
samplerate, data = wavfile.read('/home/bhaskar/Desktop/Honors/Syllables Count Timit/wav/SX82.wav')
...
phoneme_bounds = []
phoneme_labels = []
with open('/home/bhaskar/Desktop/Honors/Syllables Count Timit/TIMIT Samples/Phoneme/SX82.PHN', 'r') as file:
    for line in file:
