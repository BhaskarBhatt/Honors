...
samplerate, data = wavfile.read('/home/bhaskar/Desktop/Honors/Task 4 (Isolated Vowels)/wav/ta.wav')
...
# Load the features
features = np.load('/home/bhaskar/Desktop/Honors/Task 4 (Isolated Vowels)/extracted_features/ta.npy') 
