...
# eg: Sheep, Beach, Reach

# Read audio file and find its sample rate
samplerate, data = wavfile.read('/home/bhaskar/Desktop/Honors/Task 4 (Isolated Vowels)/wav/iy.wav')
...
# Load the features
features = np.load('/home/bhaskar/Desktop/Honors/Task 4 (Isolated Vowels)/extracted_features/iy.npy') 
