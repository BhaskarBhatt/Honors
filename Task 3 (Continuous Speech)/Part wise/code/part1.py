...
samplerate, data = wavfile.read('/home/bhaskar/Desktop/Honors/Task 3/Part wise/wav/Part 1.wav')
...
# Load the features
features = np.load('/home/bhaskar/Desktop/Honors/Task 3/Part wise/extracted_features/Part 1.npy') 
