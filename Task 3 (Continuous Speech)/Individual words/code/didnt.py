...
samplerate, data = wavfile.read('/home/bhaskar/Desktop/Honors/Task 3/Individual words/wav/Didn\'t.wav')
...
# Load the features
features = np.load('/home/bhaskar/Desktop/Honors/Task 3/Individual words/extracted_features/Didn\'t.npy') 
