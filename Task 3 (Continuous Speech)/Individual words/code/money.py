...
samplerate, data = wavfile.read('/home/bhaskar/Desktop/Honors/Task 3/Individual words/wav/Money.wav')
...
# Load the features
features = np.load('/home/bhaskar/Desktop/Honors/Task 3/Individual words/extracted_features/Money.npy') 
